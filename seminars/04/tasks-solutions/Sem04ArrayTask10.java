...
public class Sem04ArrayTask10 {
    public static void main(String[] args) {
        ...
        int[] result = removeEveryKth(array, k);
    ...
    public static int[] removeEveryKth(int[] array, int k) {
        ...
        for (int i = 0; i < array.length; ++i) {
            ...
            result[actualLength] = array[i];
            ++actualLength;
        }
        return Arrays.copyOf(result, actualLength); // Сжимаем массив до нужной длины
    }
}