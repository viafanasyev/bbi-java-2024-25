...
public class Sem05Task5 {
    public static void main(String[] args) {
        ...
        int[] reversedArray = reverseOutOfPlace(array);

        System.out.println("Развёрнутый массив: " + Arrays.toString(reversedArray));
    ...
    public static int[] reverseOutOfPlace(int[] array) {
